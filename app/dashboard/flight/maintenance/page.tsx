            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-gray-900">East Coast Aviation Services</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">James Wilson</p>
                  <p className="text-sm text-gray-600">A&P #3456789, IA</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Atlantic Aviation Insurance</p>
                  <p className="text-sm text-gray-600">Policy #ATL-2024-321</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">John F. Kennedy International</p>
                  <p className="text-sm text-gray-600">KJFK</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Miami International</p>
                  <p className="text-sm text-gray-600">KMIA</p>
                </div>
              </div>
            </Card>
          </div>
