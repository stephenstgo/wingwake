            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-gray-900">Pacific Flight Academy</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">CFI, CFII</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Robert Martinez</p>
                  <p className="text-sm text-gray-600">A&P #2345678</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Northwest Aviation Insurance</p>
                  <p className="text-sm text-gray-600">Policy #NW-2024-456</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Seattle-Tacoma International</p>
                  <p className="text-sm text-gray-600">KSEA</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Portland International</p>
                  <p className="text-sm text-gray-600">KPDX</p>
                </div>
              </div>
            </Card>
          </div>
