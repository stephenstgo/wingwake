...
export default function StorageFlightPage() {
  ...
  const initialFiles = useMemo<UploadedFile[]>(() => {
    const files: UploadedFile[] = [
      {
        id: 'reg-1',
        file: createMockFile('Aircraft_Registration_NFAKE4.pdf', 'application/pdf', 245760),
        type: 'pdf',
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Storage Relocation: NFAKE4 • KATL → KPHX</p>
            </div>
          </div>
        </div>
            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">NFAKE4</p>
                </div>
