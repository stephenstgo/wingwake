...
export default function StorageFlightPage() {
  ...
  const initialFiles = useMemo<UploadedFile[]>(() => {
    const files: UploadedFile[] = [
      {
        id: 'reg-1',
        file: createMockFile('Aircraft_Registration_N22222.pdf', 'application/pdf', 245760),
        type: 'pdf',
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Storage Relocation: N22222 • KATL → KPHX</p>
            </div>
          </div>
        </div>
            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-gray-900">Aircraft Storage Solutions LLC</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Beechcraft Baron 58</p>
                  <p className="text-sm text-gray-600">N22222</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Kevin Park</p>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Amanda Foster</p>
                  <p className="text-sm text-gray-600">A&P #8901234</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Southwest Aviation Insurance</p>
                  <p className="text-sm text-gray-600">Policy #SW-2024-369</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Hartsfield-Jackson Atlanta International</p>
                  <p className="text-sm text-gray-600">KATL</p>
                </div>
