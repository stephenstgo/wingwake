            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-gray-900">Mountain View Aviation</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Mark Davis</p>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Patricia Lee</p>
                  <p className="text-sm text-gray-600">A&P #5678901, IA</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Rocky Mountain Aviation Insurance</p>
                  <p className="text-sm text-gray-600">Policy #RM-2024-987</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Denver International</p>
                  <p className="text-sm text-gray-600">KDEN</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Salt Lake City International</p>
                  <p className="text-sm text-gray-600">KSLC</p>
                </div>
              </div>
            </Card>
          </div>
