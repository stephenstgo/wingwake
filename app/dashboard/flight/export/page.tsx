...
export default function ExportFlightPage() {
  ...
  const initialFiles = useMemo<UploadedFile[]>(() => {
    const files: UploadedFile[] = [
      {
        id: 'reg-1',
        file: createMockFile('Aircraft_Registration_NXXXXX.pdf', 'application/pdf', 245760),
        type: 'pdf',
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Export Flight: NXXXXX • KIAH → CYYZ</p>
            </div>
          </div>
        </div>
            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">NXXXXX</p>
                </div>
