...
export default function DeliveryFlightPage() {
  ...
  const initialFiles = useMemo<UploadedFile[]>(() => {
    const files:UploadedFile[] = [
      {
        id: 'reg-1',
        file: createMockFile('Aircraft_Registration_N13579.pdf', 'application/pdf', 245760),
        type: 'pdf',
        category: 'registration',
      },
      // Missing: Airworthiness Certificate, Logbooks, Weight & Balance, Mechanic Statement, FAA Form
    ];
    return files;
  }, []);
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Delivery Flight: N13579 • KDFW → KPHX</p>
            </div>
          </div>
        </div>
            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-gray-900">Southwest Aircraft Sales</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Mooney M20J</p>
                  <p className="text-sm text-gray-600">N13579</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">ATP, CFI, MEI</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Thomas Anderson</p>
                  <p className="text-sm text-gray-600">A&P #4567890</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Desert Aviation Insurance</p>
                  <p className="text-sm text-gray-600">Policy #DSR-2024-654</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Dallas/Fort Worth International</p>
                  <p className="text-sm text-gray-600">KDFW</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Phoenix Sky Harbor International</p>
                  <p className="text-sm text-gray-600">KPHX</p>
                </div>
              </div>
            </Card>
          </div>
