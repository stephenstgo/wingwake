            ...
            <Card className="p-6 bg-white shadow-sm sticky top-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-gray-900">Midwest Aviation Services</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Daniel Kim</p>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Rachel Moore</p>
                  <p className="text-sm text-gray-600">A&P #9012345</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Great Lakes Aviation Insurance</p>
                  <p className="text-sm text-gray-600">Policy #GL-2024-741</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">Detroit Metropolitan Wayne County</p>
                  <p className="text-sm text-gray-600">KDTW</p>
                </div>
